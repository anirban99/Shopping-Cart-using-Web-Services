...
//This class is for SOAP client screen
public class SOAPclientScreen {
  ...
  // private JLabel msglabel;
   ...
   public SOAPclientScreen(){
	   ...
	   myclient1 = new MyClientSOAP("SOAPClient");
...
//method to show user cart pannel
   ...
   public static void main(String[] args){
	   SOAPclientScreen startup = new SOAPclientScreen();
